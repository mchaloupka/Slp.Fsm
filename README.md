...
--- | --- | ---
Slp.Fsm | [![NuGet Badge](https://buildstats.info/nuget/Slp.Fsm)](https://www.nuget.org/packages/Slp.Fsm/) | [![NuGet Badge](https://buildstats.info/nuget/Slp.Fsm?includePreReleases=true)](https://www.nuget.org/packages/Slp.Fsm/)
...
- `DotnetPack` - Runs [dotnet pack](https://docs.microsoft.com/en-us/dotnet/core/tools/dotnet-pack).
